...
dir_img = r'F:\11bishe\neimofenge\zongdan\train_Augmentation\img/'
dir_mask = r'F:\11bishe\neimofenge\zongdan\train_Augmentation\mask/'
...
def get_args():
    ...
    parser.add_argument('-e', '--epochs', metavar='E', type=int, default=95,
...
if __name__ == '__main__':
    ...
    #set_freeze_by_names(net, ['up1', 'up2', 'up3', 'up4', 'outc'])
